...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj29332 = {};return obj29332;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__3614__auto__ = this$;if(and__3614__auto__)
...
{var x__4262__auto__ = (((this$ == null))?null:this$);return (function (){var or__3626__auto__ = (weasel.impls.websocket.open_QMARK_[(function (){var G__29336 = x__4262__auto__;return goog.typeOf(G__29336);
})()]);if(or__3626__auto__)
{return or__3626__auto__;
} else
{var or__3626__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__3626__auto____$1)
...
return (function (p__29341){var vec__29342 = p__29341;var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29342,(0),null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29342,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k.toLowerCase()),v], null);
});})(this$__$1))
