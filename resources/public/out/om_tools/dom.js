...
*/
om_tools.dom.opt_key_case = (function opt_key_case(attr){if(cljs.core.truth_((function (){var or__3626__auto__ = (cljs.core.count(attr) < (5));if(or__3626__auto__)
...
*/
om_tools.dom.opt_key_alias = (function opt_key_alias(opt){var G__23912 = (((opt instanceof cljs.core.Keyword))?opt.fqn:null);switch (G__23912) {
case "for":
...
{var G__23915 = opt_val;return (om_tools.dom.format_opts.cljs$core$IFn$_invoke$arity$1 ? om_tools.dom.format_opts.cljs$core$IFn$_invoke$arity$1(G__23915) : om_tools.dom.format_opts.call(null,G__23915));
} else
{return opt_val;
...
{return cljs.core.clj__GT_js(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__23918){var vec__23919 = p__23918;var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23919,(0),null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23919,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [om_tools.dom.format_opt_key(k),om_tools.dom.format_opt_val(v)], null);
}),opts)));
} else
{return opts;
}
...
om_tools.dom.element = (function element(ctor,opts,children){var vec__23921 = om_tools.dom.element_args(opts,children);var opts__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23921,(0),null);var children__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23921,(1),null);return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(ctor,cljs.core.flatten(cljs.core.cons(opts__$1,children__$1)));
});
