...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4202__auto__,writer__4203__auto__,opt__4204__auto__){return cljs.core._write(writer__4203__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_26842 = (0);while(true){
if((i_26842 < arr.length))
{(arr[i_26842] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4202__auto__,writer__4203__auto__,opt__4204__auto__){return cljs.core._write(writer__4203__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_26855 = (self__.level + (1));while(true){
if((i_26855 <= (new_level + (1))))
{(update[i_26855] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_26857 = (0);while(true){
if((i_26857 <= self__.level))
{var links_26858 = (update[i_26857]).forward;if(((links_26858[i_26857]) === x__$1))
{(links_26858[i_26857] = (x__$1.forward[i_26857]));
{
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3626__auto__,timeout__$1,me){
