...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t27006 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t27006 = (function (val,box,meta27007){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t27006.cljs$lang$type = true;
cljs.core.async.impl.channels.t27006.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t27006";
cljs.core.async.impl.channels.t27006.cljs$lang$ctorPrWriter = (function (this__4202__auto__,writer__4203__auto__,opt__4204__auto__){return cljs.core._write(writer__4203__auto__,"cljs.core.async.impl.channels/t27006");
});
cljs.core.async.impl.channels.t27006.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t27006.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27008){var self__ = this;
var _27008__$1 = this;return self__.meta27007;
});
cljs.core.async.impl.channels.t27006.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27008,meta27007__$1){var self__ = this;
var _27008__$1 = this;return (new cljs.core.async.impl.channels.t27006(self__.val,self__.box,meta27007__$1));
});
cljs.core.async.impl.channels.__GT_t27006 = (function __GT_t27006(val__$1,box__$1,meta27007){return (new cljs.core.async.impl.channels.t27006(val__$1,box__$1,meta27007));
});
}
return (new cljs.core.async.impl.channels.t27006(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4205__auto__,writer__4206__auto__,opts__4207__auto__){return cljs.core._write(writer__4206__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4202__auto__,writer__4203__auto__,opt__4204__auto__){return cljs.core._write(writer__4203__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_27011 = self__.takes.pop();if((taker_27011 == null))
{} else
{if(taker_27011.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_27012 = taker_27011.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_27012,taker_27011,this$__$1){
return (function (){var G__27009 = null;return (take_cb_27012.cljs$core$IFn$_invoke$arity$1 ? take_cb_27012.cljs$core$IFn$_invoke$arity$1(G__27009) : take_cb_27012.call(null,G__27009));
});})(take_cb_27012,taker_27011,this$__$1))
);
} else
{}
{
...
return (function (){var G__27010 = val;return (take_cb.cljs$core$IFn$_invoke$arity$1 ? take_cb.cljs$core$IFn$_invoke$arity$1(G__27010) : take_cb.call(null,G__27010));
