...
{return s.replace((new RegExp((function (){var G__23877 = match;return goog.string.regExpEscape(G__23877);
})(),"g")),replacement);
} else
...
{{
var G__23878 = cljs.core.pop(v__$1);
v__$1 = G__23878;
continue;
}
} else
...
{var pred__23886 = cljs.core._EQ_;var expr__23887 = limit;if(cljs.core.truth_((function (){var G__23889 = (1);var G__23890 = expr__23887;return (pred__23886.cljs$core$IFn$_invoke$arity$2 ? pred__23886.cljs$core$IFn$_invoke$arity$2(G__23889,G__23890) : pred__23886.call(null,G__23889,G__23890));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__23891 = (2);var G__23892 = expr__23887;return (pred__23886.cljs$core$IFn$_invoke$arity$2 ? pred__23886.cljs$core$IFn$_invoke$arity$2(G__23891,G__23892) : pred__23886.call(null,G__23891,G__23892));
})()))
...
var G__23896 = s__$1.substring((index + cljs.core.count(m)));
var G__23897 = (limit__$1 - (1));
var G__23898 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__23896;
limit__$1 = G__23897;
parts = G__23898;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__23900 = s;return goog.string.trim(G__23900);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__23902 = s;return goog.string.trimLeft(G__23902);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__23904 = s;return goog.string.trimRight(G__23904);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__23907 = s;return goog.string.isEmptySafe(G__23907);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___23908 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___23908))
{var replacement_23909 = temp__4124__auto___23908;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_23909)));
} else
{buffer.append(ch);
}
{
