...
public class GettingStarted {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            results = Peer.query("[:find ?c ?n :where [?c :community/name ?n]]",
                             conn.db());
            ...
            results = Peer.query("[:find ?n ?u :where [?c :community/name ?n][?c :community/url ?u]]",
                             conn.db());
            ...
            results = Peer.query("[:find ?e ?c :where [?e :community/name \"belltown\"][?e :community/category ?c]]",
                             conn.db());
            for (Object result : results) System.out.println(result);
            ...
            results = Peer.query("[:find ?id :where [?id :community/name \"belltown\"]]",
                             conn.db());
            ...
            results = Peer.query("[:find ?id :where [?id :community/name \"Easton\"]]",
                             conn.db());
